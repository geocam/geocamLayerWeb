...
version = geocamLayer.get_version()
# The full version, including alpha/beta/rc tags.
release = geocamLayer.get_version()
...
htmlhelp_basename = 'geocamLayerWebdoc'
...
latex_documents = [
  ('index', 'app.tex', u'geocamLayerWeb Documentation',
   u'Trey Smith', 'manual'),
]
